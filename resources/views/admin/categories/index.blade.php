            ...
            <div class="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] shadow-2xl shadow-black/20">
                ...
                <div class="border-b border-white/10 bg-white/[0.02] px-6 py-5 sm:px-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 to-cyan-400 shadow-lg shadow-purple-500/20">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    >
                        ...
                        <input
                            ...
                            required
                            class="min-w-0 flex-1 rounded-xl border border-white/10 bg-[#080b12] px-4 py-3 text-sm text-white placeholder-gray-600 shadow-sm outline-none transition focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/10"
                        >

                        <button
                            type="submit"
                            class="rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-600/20 transition hover:from-purple-500 hover:to-indigo-500"
                        >
                            Add Category
                        </button>
                ...
                <div class="border-b border-white/10 bg-white/[0.02] px-6 py-5 sm:px-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Manage the categories used by your posts.
                            </p>
                        </div>
