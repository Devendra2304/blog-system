        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Write and publish a new article to DevBlog.
                </p>
            </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">
                                Add the information for your new article.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-8 sm:px-8">
                    ...
                    <form action="{{ route('admin.posts.store') }}" method="POST">
                        ...
                        <div class="flex flex-col-reverse gap-3 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-end">
                            ...
                            <button
                                type="submit"
                                class="inline-flex cursor-pointer justify-center rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-purple-600/20 transition hover:from-purple-500 hover:to-indigo-500"
                            >
                                Publish Post
                            </button>
